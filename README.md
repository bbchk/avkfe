...
implement fzf search with fuse.js
implement inProcess state
implement image fallback
place work hours in foorter
...
optimize: load responsive styles only when size of viewport is corresponding
...
p3
research robots.txt
aspect programming for javascript
